...
class Mandelbrot:
    ...
    def get_mandelbrot(self) -> np.ndarray:
        """
    ...
    def plot(self, output_file):
        ...
        """
        mandelbrot_img = self.get_mandelbrot()
        ...
        pcm = ax.pcolormesh(self.real_axis, self.imag_axis, mandelbrot_img, cmap="coolwarm")
...
if __name__ == "__main__":  
    ...
    mandelbrot = Mandelbrot(max_iters, radius, *axes)
    # Plot Mandelbrot set.
    mandelbrot.plot(output_file)
